...
double Kp=0.05; //correction prop
...
void loop() {
  ...
  vitesse=getMeanSpeed(deltaT);

  int out = PID(Vcons,vitesse,deltaT);
  //moteur.writeMicroseconds(Vcons+1500);  
  moteur.writeMicroseconds(1500 + Vcons/10 + out);
